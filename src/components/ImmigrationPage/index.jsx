...
import image from '../../assets/images/canada3.jpg'
import './immigrationElemetns.css'
import {Link as LinkS} from 'react-scroll'
const Immigration = () => {
    return (
        <div className="immigrate-container">
            <div className="im-infoWrapper">
                
                <h1 className="im-title">
                  
                Immigrate
                </h1>
                <img src={image} alt="" className="im-image" />
                <h2 className="im-title-h2">
                Immigrate to Canada
                </h2>
                <p className="im-text">
                ...
                <ul className='questions'>
                    ...
                    <LinkS to='covid'><li>Overview and COVID-19</li></LinkS>
                    <LinkS to='im-2'><li>Why Does Canada Need Immigrants?</li></LinkS>
                    <LinkS to='im-3'><li>Why Do Canadians Support Immigration?</li></LinkS>
                    <LinkS to='im-4'> <li>Skilled Worker Immigration Pathways</li></LinkS>
                    <LinkS to='im-5'><li>Express Entry</li></LinkS>
                    <LinkS to='im-6'><li>Provincial Nominee Program (PNP)</li></LinkS>
                    <LinkS to='im-7'><li>Atlantic Immigration Pilot</li></LinkS>
                    <LinkS to='im-8'><li>Other Federal Skilled Worker Programs</li></LinkS>
                    <LinkS to='im-9'><li>Business Immigration</li></LinkS>
                    <LinkS to='im-10'><li>Moving to Canada from the U.S.</li></LinkS>
                    <LinkS to='im-11'><li>Family Class Sponsorship</li></LinkS>
                    <LinkS to='im-12'><li>Find the Right Canadian Immigration Program</li></LinkS>
                    <LinkS to='im-13'><li>Frequently Asked Questions</li></LinkS>
                </ul>
                <div className="im-section" id='covid'>
                <h3 className="im-h3">
        ...
        <br /><br />
                ...
                <div className="im-section" id='im-3'>
                    ...
                    <ul>
                        ...
                        <li>22 years of age or older, depended significantly on financial support from their parents before the age of 22 and can not support themselves financially due to a physical or mental condition</li>
                        
                    </ul>

                </div>
                <div className="im-section" id='im-5'> 
                    <h3 className="im-h3">
                    Express Entry
                    </h3>
                    <p className="im-text">
...
Under its Immigration Levels Plan, Canada seeks to welcome an average of 110,000 immigrants through Express Entry each year.
                ...
                <div className="im-section" id='im-7'>
                    <h3 className="im-h3">
                ...
                <div className="im-section " id='im-10'>
                    <h3 className="im-h3">
