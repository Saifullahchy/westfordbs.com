    ...
    return (
        <div className="ab-container">
            <div className="content-wrapper">
                ...
                <img src={image} alt="" className="ab-image" height='auto' width='500px'/>
                <p className="ab-text">
               <span> Westford Immigration Services is by Md Ashiqur Rahman</span> one of the only four active ICCRC members located in Bangladesh.
                ...
                <h2 className="ab-title">His Area of expertice</h2>
                <ul className='list'>
                ...
                <h2 className="ab-title">His Education</h2>
                <p className="ab-text">
